...
public static class MarchingCube
{
    ...
    public static float PerlinNoise3D(float x, float y, float z, float offsetX, float offsetY, float offsetZ)
    {
        ...
        float AB = Mathf.PerlinNoise(x + offsetX, y + offsetY);         // get all three(3) permutations of noise for x,y and z
        float BC = Mathf.PerlinNoise(y + offsetY, z + offsetZ);
        float AC = Mathf.PerlinNoise(x + offsetX, z + offsetZ);

        float BA = Mathf.PerlinNoise(y + offsetY, x + offsetX);         // and their reverses
        float CB = Mathf.PerlinNoise(z + offsetZ, y + offsetY);
        float CA = Mathf.PerlinNoise(z + offsetZ, x + offsetX);
